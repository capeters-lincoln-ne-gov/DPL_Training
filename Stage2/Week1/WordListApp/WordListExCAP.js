...
//function echoInput(){
//  var theNewWord = document.getElementById("newWord").value
//  var theNewNumber = document.getElementById("newNumber").value
//  alert(theNewWord + ' ' + theNewNumber);
//
//}
...
function validateANDadd() {
    ...
    var theNewWord = document.getElementById("newWord").value
    var theNewNumber= document.getElementById("newNumber").value
    alert("The word and number is" + theNewWord + " " + theNewNumber);
